...
namespace IC.Application.Interfaces.Repositories
{
    public interface IGenericRepository<T> where T : class, IEntity
    {
        ...
        Task UpdateFieldsClearChangeTrackerAsync(T entity, params Expression<Func<T, object>>[] includeProperties);
        ...
        Task<string> ExecQuerySqlReturnScalar(string sql, params object[] parameters);
    }
}
