	...
	CKEDITOR.plugins.add( 'pastecode', {
		...
		init: function( editor ) {
			...
			editor.ui.addButton && editor.ui.addButton( 'PasteCode', {
				label: 'Dán mã có xử lý các thẻ, định dạng', //editor.lang.pastecode.button,
				command: commandName,
			...
			{
				return {
					title: 'Dán mã có xử lý các thẻ, định dạng', //editor.lang.pastecode.title,
					minWidth : 640,
					minHeight : 350,
					contents : [
						{
							id : 'general',
							label: 'Nội dung:', //editor.lang.pastecode.code,
							elements : [
								{
									type : 'textarea',
									id : 'contents',
									...
									//cols: 140,
									rows: 20,
									validate: CKEDITOR.dialog.validate.notEmpty('Nội dung không để trống !'), //editor.lang.pastecode.notEmpty
									required : true,
									commit : function()
									{
										...
										editor.insertHtml(result); //this.getValue()
									}
								}
							]
						}
