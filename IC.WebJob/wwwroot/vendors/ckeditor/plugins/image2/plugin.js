	...
	CKEDITOR.plugins.add( 'image2', {
		...
		init: function( editor ) {
			...
			editor.ui.addButton && editor.ui.addButton( 'Image', {
				label: editor.lang.image2.button,
				command: 'image',
				toolbar: 'insert,10'
			} );
	...
	function widgetDef( editor ) {
		...
		return {
			...
			data: function() {
				...
				if (this.data.align != 'center' && !editor.filter.checkFeature( features.align ) )
			...
			init: function() {
				...
				if ( !data.align ) {
					...
					// Read initial float style from figure/image and then remove it.
						...
						data.align = alignElement.getStyle( 'float' ) || 'center';
				...
				hasCaption:	function( shift, oldValue, newValue ) {
					...
					if ( newValue ) {
						...
						var figure = CKEDITOR.dom.element.createFromHtml( templateBlock.output( {
							...
							captionPlaceholder: shift.newData.alt || editor.lang.image2.captionPlaceholder
						} ), doc );
