CKEDITOR.plugins.add( 'html5audio', {
    requires: 'widget',
    lang: 'bg,ca,de,de-ch,el,en,eu,es,fr,ru,uk,uz,zh-cn,fa,pl,vi',
    icons: 'html5audio',
    hidpi: true,
    init: function( editor ) {
        editor.widgets.add( 'html5audio', {
             ...
             */
            allowedContent: 'figure(*);figcaption;div(!ckeditor-html5-audio){text-align,float,margin-left,margin-right}; audio[src,controls,controlslist,autoplay];',
            ...
            data: function() {
                ...
                if (this.data.src) {
                    ...
                    if (!figureElement) {
                        var figcaption = new CKEDITOR.dom.element('figure');
                    ...
                    if ( !audioElement ) {
                        ...
                        this.element.findOne('figure').append(audioElement);
                ...
                if ( audioElement ) {
                    ...
                    if (figcaption) {
                        if (this.data.caption) {
                            figcaption.setText(this.data.caption)
                        } else {
                            figcaption.setText('')
                        }
                    }
