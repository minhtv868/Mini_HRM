...
namespace IC.Shared
{
    public class Result : IResult
    {
        ...
        public static Result SuccessJson(string data)
        {
            return new Result
            {
                Succeeded = true,
        ...
        public static Task<Result> SuccessJsonAsync(string data)
        {
        ...
        public static Task<Result> FailureAsync(Exception exception)
        {
    ...
    public class Result<T> : Result, IResult<T>
    {
        ...
        public static new Result<T> SuccessJson(string data)
        {
            return new Result<T>
            {
                Succeeded = true,
        ...
        public static new Task<Result<T>> SuccessJsonAsync(string data)
        {
            return Task.FromResult(SuccessJson(data));
        }
        ...
        public static new Task<Result<T>> FailureAsync(List<string> messages)
        {
            return Task.FromResult(Failure(messages));
        }
        ...
        public static new Task<Result<T>> FailureAsync(Exception exception)
        {
            return Task.FromResult(Failure(exception));
        }
