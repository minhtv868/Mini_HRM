        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DataTypeId = table.Column<byte>(type: "tinyint", nullable: true),
                    ArticleTypeId = table.Column<byte>(type: "tinyint", nullable: true),
                    ReviewStatusId = table.Column<byte>(type: "tinyint", nullable: false),
                    ...
                    RevUserId = table.Column<int>(type: "int", nullable: true),
                    RevDateTime = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DataTypeId = table.Column<short>(type: "smallint", nullable: true),
                    SiteId = table.Column<short>(type: "smallint", nullable: true),
                    MetaTitle = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    H1Tag = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SeoFooter = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ParentCategoryId = table.Column<int>(type: "int", nullable: true),
                    CategoryLevel = table.Column<byte>(type: "tinyint", nullable: true),
                    ImagePath = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DisplayOrder = table.Column<int>(type: "int", nullable: true),
                    TreeOrder = table.Column<int>(type: "int", nullable: true),
                    ReviewStatusId = table.Column<byte>(type: "tinyint", nullable: false),
                    CrUserId = table.Column<int>(type: "int", nullable: true),
                    CrDateTime = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DataSouceName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DataId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DataJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    JobName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsPublicJob = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    JobName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    JobClassName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    JobClassType = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CrUserId = table.Column<int>(type: "int", nullable: true),
                    CrDateTime = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MessageSendId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SiteId = table.Column<short>(type: "smallint", nullable: true),
                    MessageTemplateId = table.Column<short>(type: "smallint", nullable: false),
                    ...
                    SendMethodId = table.Column<byte>(type: "tinyint", nullable: false),
                    SendStatusId = table.Column<byte>(type: "tinyint", nullable: false),
                    CrDateTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    SendTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    OpenMailTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ClickLinkTime = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MessageSends", x => x.MessageSendId);
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "1", "Super Admin", "Super Admin", "SUPER ADMIN" },
                    { 2, "1", "Administrator", "Admin", "ADMIN" },
                    { 3, "2", "Quảng cáo", "Quảng cáo", "ADVERT" },
                    { 4, "2", "Khách hàng", "Customer", "CUSTOMER" }
                });
            ...
            migrationBuilder.InsertData(
                table: "SysFunctions",
                columns: new[] { "Id", "CssMenuActive", "CssMenuOpen", "DisplayOrder", "FunctionDesc", "FunctionName", "IconPath", "IsShow", "TreeLevel", "TreeOrder", "Url" },
                values: new object[] { 1, null, null, 10, "Hệ thống", "Hệ thống", "nav-icon fas fa-cog", true, (byte)1, 1, "/" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 2, null, null, 1, "Danh sách user", "Danh sách user", null, 1, (byte)2, 2, "/Identity/SysUsers" },
                    { 3, null, null, 2, "Danh sách quyền", "Danh sách quyền", null, 1, (byte)2, 3, "/Identity/SysRoles" },
                    { 4, null, null, 3, "Danh sách chức năng", "Danh sách chức năng", null, 1, (byte)2, 4, "/Identity/SysFunctions" },
                    { 5, null, null, 4, "Log đăng nhập", "Log đăng nhập", null, 1, (byte)2, 5, "/Identity/UserLogs" },
                    { 6, null, null, 5, "Log hệ thống", "Log hệ thống", null, 1, (byte)2, 6, "/Identity/SysLogs" },
                    { 7, null, null, 6, "Log file", "Log file", null, 1, (byte)2, 7, "/Identity/SysLogFiles" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, null, null, null, "", "admin@gmail.com", "Administrator", null, null, null, "admin@gmail.com", "admin", null, "AQAAAAIAAYagAAAAEJBK7z1L255rMgPDQuPdNX/a+MyvTXVKv2Kqi2W6K/ocD0uOFwmuNkl8kHYQygXrUQ==", null, "", "admin" });
