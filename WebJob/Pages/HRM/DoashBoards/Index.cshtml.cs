...
namespace WebJob.Pages.HRM.DoashBoards
{
    public class IndexModel : BasePageModel
    {
        //[BindProperty]
        //public DoashBoardGetPageQuery Query { get; set; }
        //public PaginatedResult<DoashBoardGetPageDto> PaginatedResult;
        ...
        //public async Task<IActionResult> OnGetBindDataAsync(DoashBoardGetPageQuery query, [FromQuery] int page = 1)
        //{
        //    SiteList = await Mediator.Send(new SiteGetAllByUserQuery());
        ...
        //    var deleteResult = await Mediator.Send(new DoashBoardDeleteCommand { DoashBoardId = id });
