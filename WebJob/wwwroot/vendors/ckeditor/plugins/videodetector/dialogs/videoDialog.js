...
CKEDITOR.dialog.add( 'videoDialog', function( editor ) {
    return {
        title: 'Chèn URL video Youtube, Vimeo, Dailymotion',
        minWidth: 400,
        minHeight: 100,
        contents: [
            {
                ...
                elements: [
                    {
                        type: 'text',
                        id: 'url_video',
                        label: 'URL video Youtube, Vimeo, Dailymotion',
                        validate: CKEDITOR.dialog.validate.notEmpty( "Thiếu đường dẫn video Youtube, Vimeo, Dailymotion" )
                    }
                ]
            }
        ],
