    ...
    CKEDITOR.plugins.add( 'footnotes', {
        ...
        addFootnote: function(footnote, editor) {
            ...
            if (footnotes === null) {
                ...
                // Add header
                if (!editor.config.footnotesDisableHeader) {
                    var header_title = editor.config.footnotesTitle ? editor.config.footnotesTitle : 'Nguồn tham khảo';
                    var header_els = ['<h4>', '</h4>'];//editor.config.editor.config.footnotesHeaderEls
