...
(function () {
    CKEDITOR.dialog.add('link', function (editor) {
        var plugin = CKEDITOR.plugins.link,
            ...
            tableId = `key_${CKEDITOR.tools.getNextId()}`,
            lang = editor.lang.link, keywords = '', dialog_, newsTypeId = 0, searchByDate = 2;
        ...
        var commitParams = function (page, data) {
            ...
            1 == data[page].advRel ? data[page].advRel = 'nofollow' : 0 == data[page].advRel && (data[page].advRel = "");
        };
        ...
        return {
            ...
            contents: [{
                ...
                elements: [{
                    type: 'text',
                    id: 'linkDisplayText',
                    label: 'Nội dung hiển thị',//linkLang.displayText,
                    setup: function () {
                        this.enable();
                        ...
                        initialLinkText = keywords = this.getValue();
                    },
                    onChange: function () {
                        var dialog = this.getDialog();
                        keywords = dialog.getValueOf('info', 'linkDisplayText')
                    },
                ...
                },
                {
                    ...
                    children: [{
                        type: 'hbox',
                        widths: ['25%', '75%'],
                        className: `cke_dialog_data_url ${tableId}`,
                        children: [
                            {
                            id: 'protocol',
                            type: 'select',
                            ...
                            'default': 'https://',//editor.config.linkDefaultProtocol,
                            setup: function (data) {
                                if (data.url) {
                    ...
                    },
                        {
                            type: 'button',
                            id: 'browseData',
                            label: 'Chèn URL văn bản',
                            hidden: false,
                            className: 'cke_element cke_select_link_data',
                            onClick: () => {
                                return modalDocsGet($('.cke_select_link_data'), `${tableId}`, keywords, newsTypeId, 'Chọn văn bản', searchByDate)
                            }
                        },
                        {
                            type: 'button',
                            id: 'browseDataArticle',
                            label: 'Chèn URL bài viết',
                            hidden: false,
                            className: 'cke_element cke_select_link_data_article',
                            onClick: () => {
                                return modalNewsGet($('.cke_select_link_data_article'), `${tableId}`, keywords, newsTypeId, 'Chọn bài viết', searchByDate)
                            }
                        },
                    {
                        type: "hbox",
