...
using IC.Persistence.Configurations.Identity;
...
{
    public class ICIdentityDbContext : IdentityDbContext<User, Role, int>
    {
        public ICIdentityDbContext(DbContextOptions<ICIdentityDbContext> options)
            : base(options)
        {
        ...
        private void SeedSysFunctions(ModelBuilder builder)
        {
            builder.Entity<SysFunction>().HasData(
                ...
                new SysFunction() { Id = 2, FunctionName = "Danh sách user", FunctionDesc = "Danh sách user", Url = "/Identity/SysUsers", ParentItemId = 1, IconPath = "", DisplayOrder = 1, TreeLevel = 2, TreeOrder = 2 },
                new SysFunction() { Id = 3, FunctionName = "Danh sách quyền", FunctionDesc = "Danh sách quyền", Url = "/Identity/SysRoles", ParentItemId = 1, IconPath = "", DisplayOrder = 2, TreeLevel = 2, TreeOrder = 3 },
                new SysFunction() { Id = 4, FunctionName = "Danh sách chức năng", FunctionDesc = "Danh sách chức năng", Url = "/Identity/SysFunctions", ParentItemId = 1, IconPath = "", DisplayOrder = 3, TreeLevel = 2, TreeOrder = 4 },
                new SysFunction() { Id = 5, FunctionName = "Log đăng nhập", FunctionDesc = "Log đăng nhập", Url = "/Identity/UserLogs", ParentItemId = 1, IconPath = "", DisplayOrder = 4, TreeLevel = 2, TreeOrder = 5 },
                new SysFunction() { Id = 6, FunctionName = "Log hệ thống", FunctionDesc = "Log hệ thống", Url = "/Identity/SysLogs", ParentItemId = 1, IconPath = "", DisplayOrder = 5, TreeLevel = 2, TreeOrder = 6 },
                new SysFunction() { Id = 7, FunctionName = "Log file", FunctionDesc = "Log file", Url = "/Identity/SysLogFiles", ParentItemId = 1, IconPath = "", DisplayOrder = 6, TreeLevel = 2, TreeOrder = 7 }
