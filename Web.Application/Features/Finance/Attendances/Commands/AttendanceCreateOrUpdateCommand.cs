...
{
    public class AttendanceOrUpdateCommand : IRequest<Result<int>>, IMapFrom<Attendance>
    {
    ...
    internal class AttendanceOrUpdateCommandHandler : IRequestHandler<AttendanceOrUpdateCommand, Result<int>>
    {
        private readonly IFinanceUnitOfWork _unitOfWork;
        private readonly IMapper _mapper;
        private readonly ICurrentUserService _currentUserService;

        public AttendanceOrUpdateCommandHandler(
        ...
        public async Task<Result<int>> Handle(AttendanceOrUpdateCommand command, CancellationToken cancellationToken)
        {
